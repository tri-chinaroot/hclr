...
HCLR 衡量"你对AI输出的介入杠杆"，而 [TOA询问法](https://github.com/tri-chinaroot/toa-questioning) 解决"如何把你的意图**问出来**"——AI逐题征询、A/B/C选项快速收敛。两者配合使用：先TOA问出意图，再HCLR衡量每轮介入的效果。TOA记录（TOA-项目名-时间.md）本身即可作为HCLR的任务事件来源。
